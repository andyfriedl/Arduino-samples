...
void loop() {
  ...
  CylonEyeUp(strip.Color(22,0,55), strip.Color(2,0,11), strip.Color(1,0,4), wait_T, PixelCount, Pixel_Start_End);
  delay(wait_T);
  //Example: CylonEyeDown(Center_Dot_Color, Second_Dot_color, Third_Dot_color, wait_T, PixelCount, Pixel_Start_End);
  CylonEyeDown(strip.Color(22,0,55), strip.Color(2,0,11), strip.Color(1,0,4), wait_T, PixelCount, Pixel_Start_End);
  delay(wait_T);
}
