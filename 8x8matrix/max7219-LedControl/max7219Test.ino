...
void randomtDotRandomTime() {
  //lc.setIntensity(0,random(15));
  lc.setIntensity(0,15);

  int row = random(8), col = random(8);

  //lc.setLed(0,random(8),random(8),true);



  int dotCheck = random(3);

  if (dotCheck == 1 ||dotCheck == 2 ||dotCheck == 3) {
    lc.setLed(0,row,col,true);
    delay(100);
    lc.setLed(0,row,col,false);
