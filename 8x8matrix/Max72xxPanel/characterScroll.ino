...
void strobe(int strobeSpeed, int strobeBrightness) {
  // strobeSpeed = strobeSpeed - 0 == random
  // strobeBrightness = 1 bright - 16 low
...
void pulser(int pulseSpeed,int offDelay){
  // pulseSpeed = speed of pulse
  // offDelay = how long to stay off between pulse
